...
from remote calls, without the need to manuall wrap them in a proxy.
...
the old behavoir. You can try it with this example too, set the environment
varaible PYRO_AUTOPROXY to false and restart the server to see what
the effect is.
