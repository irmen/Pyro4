...
class MessageTestsHmacDeprecated(unittest.TestCase):
    def setUp(self):
    ...
    def testMessage(self):
        ...
        mac = pyrohmac(b"hello", Pyro4.config.HMAC_KEY, msg.annotations)
    ...
    def testAnnotations(self):
        ...
        mac = pyrohmac(b"hello", Pyro4.config.HMAC_KEY, annotations)
