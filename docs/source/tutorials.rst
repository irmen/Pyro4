...
-------------------------
To run the final stock quote system you need to do the following, each in a separate console window:

- start a Pyro name server (:command:`python -m Pyro4.naming`)
